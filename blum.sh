...
echo -e "${GREEN}Blum 봇을 설치합니다.${NC}"
echo -e "${GREEN}스크립트작성자: https://t.me/kjkresearch${NC}"
echo -e "${GREEN}출처: https://github.com/akasakaid/blumtod${NC}"

echo -e "${CYAN}이 봇은 다음과 같은 기능을 갖고 있습니다.{NC}"
echo -e "${CYAN}오토트레이드 / 오토탭/ 오토태스크{NC}"

echo -e "${GREEN}설치 옵션을 선택하세요:${NC}"
echo -e "${YELLOW}1. Blum 봇 새로 설치${NC}"
echo -e "${YELLOW}2. 기존정보 그대로 이용하기(재실행)${NC}"
echo -e "${YELLOW}3. Blum 봇 업데이트${NC}"
read -p "선택: " choice

case $choice in
  1)
    echo -e "${GREEN}Blum 봇을 새로 설치합니다.${NC}"
